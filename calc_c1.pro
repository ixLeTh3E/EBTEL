 pro calc_c1, temp, den, length, rad, c1
     ...
     ;Modification for conductive cooling phase
     r3_cond_0=6.
     l_fact_cond=5.
     ...
     r3_cond_g = r3_cond_0*exp(2*2*sin(3.14159/l_fact_cond)*length/3.14159/sc)
     ;
     ...
     r3_cond =  r3_cond_g*1.95e-18/temp^(2./3.)/rad
...
;     r3_radn = r3_radn_g
     ...
     ;r3=r3_eqm ;the situation in EBTEL2
     r3=(2*r3_eqm+r3_cond*(1/noneq2-1.))/(1+1/noneq2) ; shifted to EBTEL3 by considering the underdense in hot loops
     endif
   ...
   ;  c1=4. ; shifted to EBTEL1 with C1 fixed at 4
     return
   end